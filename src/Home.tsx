	...
	return (
		<SectionsContext value={sections}>
			<div>
				...
				>
					<section id={sections[0].text} className="flex flex-col mx-7.5 lg:mx-0 lg:flex-row gap-10 justify-center">
						<Card
							igIcon={igIcon}
							gmailIcon={gmailIcon}
				...
				<section id={sections[1].text} ref={sections[1].ref} className="h-100 w-full bg-orange-700">
					<h2 className="text-3xl text-white">
						{sections[1].text}
					</h2>
				</section>
				<section id={sections[2].text} ref={sections[2].ref} className="h-100 w-full bg-orange-300">
					<h2 className="text-3xl text-white">
						{sections[2].text}
					</h2>
				</section>
